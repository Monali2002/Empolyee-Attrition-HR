...
class PromotionAnalysis : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_promotion_analysis)
    ...
    private fun preparePieChartData() {
        ...
        entries.add(PieEntry(98.3f, "0"))
        entries.add(PieEntry(1.7f, "1"))

        val dataSet = PieDataSet(entries, "Promotion_last_5years")
    ...
    private fun getBarChartDataForSet1(): ArrayList<BarEntry> {
        ...
        barEntriesList.add(BarEntry(1f, 9805f))
        barEntriesList.add(BarEntry(2f, 195f))
    ...
    private fun getBarChartDataForSet2(): ArrayList<BarEntry> {
        ...
        barEntriesList.add(BarEntry(1f, 1983f))
